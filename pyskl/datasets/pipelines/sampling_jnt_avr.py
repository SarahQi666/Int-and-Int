...
class TimeWindowSampleFrames_jnt_avr:
    ...
    def _get_train_clips(self, num_frames, clip_len,num_keypoint,num_person,real_num_person,kp):
        ...
        """
        allinds = []
        sv=self._jnt_avr_sv(num_frames,num_keypoint,num_person,real_num_person,kp)
    ...
    def _get_test_clips(self, num_frames, clip_len,num_keypoint,num_person,real_num_person,kp):
        ...
        print('np.concatenate(allinds)',np.concatenate(allinds)) 
        return np.concatenate(allinds)
...
@PIPELINES.register_module()
class TimeWindowSampleFrames_random:
    """TimeWindow sample frames from the video.
    ...
    def _get_train_clips(self, num_frames, clip_len,num_keypoint,num_person,real_num_person,kp):
        ...
        for clip_idx in range(self.num_clips):
            ...
            svmax_idx=int(np.random.uniform(0,num_frames))
