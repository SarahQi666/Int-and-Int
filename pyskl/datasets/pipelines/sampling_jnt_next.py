...
class TimeWindowSampleFrames_jnt_next:
    ...
    def _jnt_next_sv(self,num_frames,num_keypoint,num_person,real_num_person,kp):
        ...
        Args:
            ...
            num_keypoint (int): The number of keypoints.（“K”）
    ...
    def _get_train_clips(self, num_frames, clip_len,num_keypoint,num_person,real_num_person,kp):
        ...
        """
        allinds = []
        sv=self._jnt_next_sv(num_frames,num_keypoint,num_person,real_num_person,kp)
