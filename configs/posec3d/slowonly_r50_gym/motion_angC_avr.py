...
train_pipeline = [
    dict(type='TimeWindowSampleFrames_angC_avr', clip_len=48),
...
val_pipeline = [
    dict(type='TimeWindowSampleFrames_angC_avr', clip_len=48, num_clips=1),
    dict(type='PoseDecode'),
    dict(type='PoseCompact', hw_ratio=1., allow_imgpad=True),
...
log_level = 'INFO'
work_dir = './work_dirs/posec3d/slowonly_r50_gym/motion_angC_avr'
